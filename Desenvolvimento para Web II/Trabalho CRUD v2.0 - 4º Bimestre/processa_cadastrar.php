<?php
	...
	if ($conexao) {
		if (isset($_GET['marca']) and isset($_GET['modelo']) and isset($_GET['placa']) and isset($_GET['final_placa']) and 
			isset($_GET['data_compra']) and isset($_GET['seguro']) and isset($_GET['descricao'])) {
			$marca = $_GET['marca'];
			$modelo = $_GET['modelo'];
			...
			if ($_GET['marca'] != null and $_GET['modelo'] != null and $_GET['placa'] != null and $_GET['final_placa'] !=null and 
			$_GET['data_compra'] != null and $_GET['seguro'] != null and $_GET['descricao'] != null) {
					...
					if ($placa_mask = explode('-', $placa)) {
						...
						if ($placa_mask[0] == "XXX" and $placa_mask[1] == "XXXX") {
							...
							if (checkdate($data[1], $data[2], $data[0])) {
								$sql = "INSERT INTO veiculo(marca, modelo, placa, final_placa, data_compra, seguro, descricao) 
								VALUES('$marca', '$modelo', '$placa', $final_placa, '$data_compra', '$seguro', '$descricao');";
