	...
	<body>
		...
		<div class="container" style="max-width: 900px;">
			...
			<div class="alert alert-success alert-dismissible fade hidden" id="alert-enviado" role="alert">
				Os dados foram gravados com <strong>sucesso</strong>!
			...
			<form action="" method="GET" name="form_cadastrar" onsubmit="return false;">
				<fieldset class="form-group">
					<legend>Cadastrar Veículos</legend>
					<div class="form-row">
						<div class="col">
							<label>Marca:</label>
							<input type="text" name="marca" class="form-control" id="marca" placeholder="Land Rover">
							<small class="form-text erro_campo" id="erro_campo_marca">Este campo é obrigatório!</small>
						</div>
						<div class="col">
							<label>Modelo:</label>
							<input type="text" name="modelo" class="form-control" id="modelo" placeholder="Range Rover Evoque">
					...
					<div class="form-row">
						<div class="col">
							<label>Placa:</label>
							<input type="text" name="placa" class="form-control" id="placa" placeholder="PHP-1208">
							<small class="form-text erro_campo" id="erro_campo_placa">Este campo é obrigatório!</small>
						</div>
						<div class="col">
							<label>Dígito final da placa:</label>
							<input type="text" name="final_placa" class="form-control" id="final_placa" placeholder="8">
